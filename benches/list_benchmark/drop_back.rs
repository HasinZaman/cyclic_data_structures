...
macro_rules! list_drop_back_benchmark {
    ($SIZE: literal, $c: expr, $small_vec: literal) => {
        ...
        $c.bench_function(
            &format!(
                "Cyclic List (no write_over) (no optimization) - drop_back {}",
                $SIZE
            ),
            |b| {
        ...
        $c.bench_function(
            &format!(
                "Cyclic List (write_over) (no optimization) - drop_back {}",
                $SIZE
            ),
            |b| {
        ...
        $c.bench_function(
            &format!(
                "Cyclic List (no write_over) (optimization) - drop_back {}",
                $SIZE
            ),
            |b| {
                let mut list: List<$SIZE, usize, false> = List::default();
        ...
        $c.bench_function(
            &format!(
                "Cyclic List (write_over) (optimization) - drop_back {}",
                $SIZE
            ),
            |b| {
                let mut list: List<$SIZE, usize, true> = List::default();
        ...
        //vec
        $c.bench_function(&format!("vec (remove) - drop_back {}", $SIZE), |b| {
        ...
        $c.bench_function(&format!("vec (pop) - drop_back {}", $SIZE), |b| {
            let mut list = Vec::new();
        ...
        //linked list
        $c.bench_function(&format!("linked_list - drop_back {}", $SIZE), |b| {
        ...
        //small vec
        $c.bench_function(&format!("small vec (remove) - drop_back {}", $SIZE), |b| {
        ...
        $c.bench_function(&format!("small vec (pop) - drop_back {}", $SIZE), |b| {
            let mut list: SmallVec<[_; $small_vec]> = SmallVec::with_capacity($SIZE);
        ...
        //arrayvec
        $c.bench_function(&format!("arrayvec (pop) - drop_back {}", $SIZE), |b| {
        ...
        $c.bench_function(&format!("arrayvec (remove) - drop_back {}", $SIZE), |b| {
            let mut list: ArrayVec<usize, $SIZE> = ArrayVec::new();
        ...
        //ring queue
        $c.bench_function(&format!("ring queue - drop_back {}", $SIZE), |b| {
    ...
    ($SIZE: literal, $c: expr, $small_vec: literal, $array_deque: literal) => {
        ...
        //array deque
        $c.bench_function(&format!("array deque - drop_back {}", $SIZE), |b| {
