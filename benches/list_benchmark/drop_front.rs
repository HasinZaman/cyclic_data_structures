...
macro_rules! list_drop_front_benchmark{
    ($SIZE: literal, $c: expr, $small_vec: literal) => {
        //cyclic list
        $c.bench_function(
            &format!("Cyclic List (no write_over) (no optimization) - drop_front {}", $SIZE),
            |b| {
        ...
        $c.bench_function(
            &format!("Cyclic List (write_over) (no optimization) - drop_front {}", $SIZE),
            |b| {
        ...
        $c.bench_function(
            &format!("Cyclic List (no write_over) (optimization) - drop_front {}", $SIZE),
            |b| {
                let mut list: List<$SIZE, usize, false> = List::default();
                for i in 0..$SIZE {
                    let _ = list.push_back(black_box(i));
        ...
        $c.bench_function(
            &format!("Cyclic List (write_over) (optimization) - drop_front {}", $SIZE),
            |b| {
        ...
        //vec
        $c.bench_function(
            &format!("vec (remove(0)) - drop_front {}", $SIZE),
            |b| {
        ...
        //linked list
        $c.bench_function(
            &format!("linked_list - drop_front {}", $SIZE),
            |b| {
        ...
        //small vec
        $c.bench_function(
            &format!("small vec - drop_front {}", $SIZE),
            |b| {
        ...
        //circular queue
        $c.bench_function(
            &format!("circular queue - drop_front {}", $SIZE),
            |b| {
        ...
        //arrayvec
        $c.bench_function(
            &format!("arrayvec - drop_front {}", $SIZE),
            |b| {
        ...
        //ring queue
        $c.bench_function(
            &format!("ring queue - drop_front {}", $SIZE),
            |b| {
    ...
    ($SIZE: literal, $c: expr, $small_vec: literal, $array_deque: literal) => {
        ...
        //array deque
        $c.bench_function(
            &format!("array deque - drop_front {}", $SIZE),
            |b| {
