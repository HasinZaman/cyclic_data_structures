...
macro_rules! list_generation_benchmark {
    ($SIZE: literal, $c: expr, $small_vec: literal) => {
        ...
        $c.bench_function(
            &format!(
                "Cyclic List (default) (no write_over) (no optimization) - generate {}",
                $SIZE
            ),
            |b| {
                b.iter(|| {
        ...
        $c.bench_function(
            &format!(
                "Cyclic List (default) (write_over) (no optimization) - generate {}",
                $SIZE
            ),
            |b| {
                b.iter(|| {
        ...
        $c.bench_function(
            &format!(
                "Cyclic List (default) (no write_over) (optimization) - generate {}",
                $SIZE
            ),
            |b| {
                b.iter(|| {
        ...
        $c.bench_function(
            &format!(
                "Cyclic List (default) (write_over) (optimization) - generate {}",
                $SIZE
            ),
            |b| {
                b.iter(|| {
        ...
        //vec
        $c.bench_function(&format!("vec (new) - generate {}", $SIZE), |b| {
            b.iter(|| {
        ...
        $c.bench_function(&format!("vec (from_alloc) - generate {}", $SIZE), |b| {
            b.iter(|| {
        ...
        //linked list
        $c.bench_function(&format!("linked_list - generate {}", $SIZE), |b| {
            b.iter(|| {
        ...
        //ring buffer
        $c.bench_function(&format!("Ring buffer - generate {}", $SIZE), |b| {
            b.iter(|| {
        ...
        //small vec
        $c.bench_function(&format!("small vec (new) - generate {}", $SIZE), |b| {
            b.iter(|| {
        ...
        //circular queue
        $c.bench_function(&format!("circular queue - generate {}", $SIZE), |b| {
            b.iter(|| {
        ...
        //arrayvec
        $c.bench_function(&format!("arrayvec (push) - generate {}", $SIZE), |b| {
            b.iter(|| {
        ...
        $c.bench_function(&format!("arrayvec (try push) - generate {}", $SIZE), |b| {
            b.iter(|| {
                let mut list: ArrayVec<usize, $SIZE> = ArrayVec::new();
        ...
        //ring queue
        $c.bench_function(&format!("ring queue (new) - generate {}", $SIZE), |b| {
            b.iter(|| {
    ...
    ($SIZE: literal, $c: expr, $small_vec: literal, $array_deque: literal) => {
        ...
        //array deque
        $c.bench_function(&format!("array deque - generate {}", $SIZE), |b| {
            b.iter(|| {
